        ...
        <div className='p-4 border-b border-white/5'>
          <div className='relative'>
            ...
            <input
              ...
              className='w-full pl-10 pr-4 py-3 bg-[#131520] border border-white/10 rounded-xl text-[color:var(--app-text)] placeholder-gray-500 focus:outline-none focus:border-blue-500/50'
              autoFocus
            />
          </div>
        </div>
        ...
        <div className='flex-1 overflow-y-auto'>
          {!selectedFood ? (
              ...
              {searchResults.map((food) => (
                ...
                >
                    ...
                    {(food as any).source && (
                      <div className='text-[10px] px-2 py-0.5 rounded bg-blue-500/10 text-blue-400 border border-blue-500/20 whitespace-nowrap'>
                        {(food as any).source === 'usda'
                          ? 'USDA'
                          : (food as any).source === 'open_food_facts'
                            ? 'OFF'
                            : 'Custom'}
                      </div>
                    )}
                  ...
                  <div className='text-xs text-gray-400 mt-1'>
                    ...
                    · C: {food.carbs_per_100g}g · F: {food.fat_per_100g}g (per
                    100g)
                  </div>
                </button>
              ))}
            ...
            <div className='p-4'>
              ...
              {selectedFood.serving_sizes &&
                selectedFood.serving_sizes.length > 0 && (
                  <div className='mb-4'>
                    <label className='text-sm font-semibold text-[color:var(--app-text)] mb-2 block'>
                      Quick Add
                    </label>
                    <div className='grid grid-cols-2 gap-2'>
                      {selectedFood.serving_sizes.map((serving, index) => (
                        <button
                          ...
                          className='px-3 py-2 bg-[#131520] border border-white/10 rounded-lg text-sm text-[color:var(--app-text)] hover:border-blue-500/50 transition-colors text-left'
                        >
              ...
              {nutrition && (
                <div className='bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-xl p-4'>
                  <div className='text-sm font-semibold text-[color:var(--app-text)] mb-3'>
                    Nutrition Facts
                  </div>
                  <div className='grid grid-cols-2 gap-3'>
                    <div className='bg-black/20 rounded-lg p-3'>
                      <div className='text-xs text-gray-400'>Calories</div>
                      <div className='text-lg font-bold text-[color:var(--app-text)]'>
                        {nutrition.calories}
                      </div>
                    </div>
                    <div className='bg-black/20 rounded-lg p-3'>
        ...
        {selectedFood && (
          <div className='p-4 border-t border-white/10'>
            <button
              ...
              className='w-full py-3.5 rounded-xl bg-blue-500 text-[color:var(--app-text)] font-semibold disabled:opacity-50 disabled:cursor-not-allowed'
            >
              Add to {mealType}
            </button>
          </div>
